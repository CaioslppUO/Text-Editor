...
public class ListenerEditorPanel implements KeyListener {
    ...
    public void keyReleased(KeyEvent e) {
        ...
        if (aux.getEditorPane().getEditorPane() != null && e.isControlDown() && e.getKeyChar() != 'r'
                && e.getKeyCode() == 82) {
            aux.runSelectedFile();
        }

        // Salva o arquivo aberto ao apertar ctrl+s
        if (aux.getEditorPane().getEditorPane() != null && e.isShiftDown() == false && e.isControlDown()
        ...
        if (aux.getEditorPane().getEditorPane() != null && e.isShiftDown() && e.isControlDown() && e.getKeyChar() != 's'
                && e.getKeyCode() == 83) {
        ...
        if (aux.getEditorPane().getEditorPane() != null && e.isControlDown() && e.getKeyChar() != 'o' && e.getKeyCode() == 79) {
            Gui.getInstance().runOpenFile();
        }

        // Cria um novo arquivo ao apertar ctr+n
        if (aux.getEditorPane().getEditorPane() != null && e.isControlDown() && e.getKeyChar() != 'n' && e.getKeyCode() == 78) {
